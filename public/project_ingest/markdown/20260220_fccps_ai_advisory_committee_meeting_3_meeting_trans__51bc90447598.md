...
[ ] [REDACTED] Black - Send another committee survey to collect feedback on principles and candidate items (notify members and solicit revisions)

[ ] [REDACTED] Black - Merge workstream deliverables and produce a consolidated 'cut list' / merged draft for the committee to review and circulate it this week

[ ] [REDACTED] Black - Receive and process written workstream inputs and materials so they can be merged for the next meeting (submit materials by next Friday to enable merging)

[ ] [REDACTED] Black - Provide a method to collect public inputs for the upcoming town hall (define collection approach and ensure it is ready by the town-hall date)
